...
import { Info, Camera, Sparkles, DollarSign } from "lucide-react";
...
import { BasicInfoStep } from "./serviceForm/steps/BasicInfoStep";
import { MediaStep } from "./serviceForm/steps/MediaStep";
import { FeaturesStep } from "./serviceForm/steps/FeaturesStep";
import { DetailsStep } from "./serviceForm/steps/DetailsStep";

const { cn } = utils.tailwindUtils;

const STORAGE_KEY = "service_form_draft";
const STEP_STORAGE_KEY = "service_form_step";
...
const steps = [
  {
    ...
    icon: Info,
    schema: serviceBasicInfoSchema,
    fields: ["title", "subtitle", "category", "description"],
  },
  {
    id: 2,
    title: "Media",
  ...
  },
  {
    ...
    icon: Sparkles,
    schema: serviceFeaturesSchema,
    fields: ["features", "longDescription"],
  },
  {
    id: 4,
    title: "Details",
...
export const ServiceFormWizard: React.FC<ServiceFormWizardProps> = ({
  ...
  const form = useForm({
    ...
    onSubmit: ({ value }: { value: ServiceFormData }) => {
      onSubmit(value);
      handleClose(onClose);
    },
  });
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="px-6 py-6 overflow-y-auto flex-1">
          ...
          {currentStep === 2 && <MediaStep form={form} isDark={isDark} />}
          {currentStep === 3 && <FeaturesStep form={form} isDark={isDark} />}
          {currentStep === 4 && <DetailsStep form={form} isDark={isDark} />}
        </div>
        <WizardFooter
          currentStep={currentStep}
