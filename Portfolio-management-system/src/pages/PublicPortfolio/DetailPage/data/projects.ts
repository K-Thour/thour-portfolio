...
export const projectsData: Record<string, ProjectData> = {
  "ai-code-assistant": {
    ...
    technologies: [
      { name: "Python", iconUrl: "" },
      { name: "OpenAI GPT-4", iconUrl: "" },
      { name: "React", iconUrl: "" },
      { name: "FastAPI", iconUrl: "" },
  ...
  "dev-workspace-pro": {
    ...
    team: "3 Developers",
    technologies: [
      { name: "Next.js", iconUrl: "" },
      { name: "TypeScript", iconUrl: "" },
      { name: "WebSocket", iconUrl: "" },
      { name: "Docker", iconUrl: "" },
      { name: "Redis", iconUrl: "" },
  ...
  "terminal-dashboard": {
    ...
    technologies: [
      ...
      { name: "React", iconUrl: "" },
      { name: "D3.js", iconUrl: "" },
      { name: "Kubernetes", iconUrl: "" },
      { name: "Prometheus", iconUrl: "" },
      { name: "WebSocket", iconUrl: "" },
    ],
    link: "#",
    github: "#",
