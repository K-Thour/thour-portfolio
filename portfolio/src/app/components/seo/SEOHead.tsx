...
export const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  const siteOrigin =
    typeof window !== 'undefined' ? window.location.origin : 'https://karanveerthour.com';
  const currentPath = location.pathname;
  const canonical = canonicalUrl || `${siteOrigin}${currentPath === '/' ? '' : currentPath}`;
  ...
  useEffect(() => {
    ...
    // 2. Primary Meta Tags
    setMetaTag('meta[name="description"]', 'name', 'description', computedDescription);
    ...
    // 3. Open Graph Tags
    setMetaTag('meta[property="og:title"]', 'property', 'og:title', computedTitle);
    setMetaTag('meta[property="og:description"]', 'property', 'og:description', computedDescription);
    setMetaTag('meta[property="og:type"]', 'property', 'og:type', ogType);
    setMetaTag('meta[property="og:url"]', 'property', 'og:url', canonical);
    setMetaTag('meta[property="og:image"]', 'property', 'og:image', computedImage);
    setMetaTag('meta[property="og:site_name"]', 'property', 'og:site_name', `${userName} Portfolio`);

    // 4. Twitter Card Tags
    setMetaTag('meta[name="twitter:card"]', 'name', 'twitter:card', 'summary_large_image');
    setMetaTag('meta[name="twitter:title"]', 'name', 'twitter:title', computedTitle);
    setMetaTag('meta[name="twitter:description"]', 'name', 'twitter:description', computedDescription);
    setMetaTag('meta[name="twitter:image"]', 'name', 'twitter:image', computedImage);
