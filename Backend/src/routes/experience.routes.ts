...
} from '../validations/experience.validations';
...
experienceRoutes.post(
  '/create',
  authMiddleware,
  validate(experienceCreateSchema),
  controllers.experienceControllers.create,
);
experienceRoutes.patch(
  '/update/:id',
  authMiddleware,
  validate(experienceUpdateSchema),
  controllers.experienceControllers.update,
);
